...
import infoEconomic from '../assets/info-economic.svg';
    ...
    <div className='w-full sm:w-1/2 p-4'>
        ...
        <div className='mt-4 items-center custom-shadow rounded-lg p-4'>
            <div className='flex items-center mb-4'>
                <h3 className='text-roboto tracking-tighter text-2xl font-medium orange-text'>{id}.- {title}</h3>
                <img src={infoEconomic} alt='info' className='ml-4' />
            </div>
...
const orangeColors = [
    '#FBC946', // Verde más claro
    '#FFB200',
    '#E4570D'  // Verde más oscuro
];
