...
const SearchIcon = ({ fill }) => (
	...
	>
		...
		<path
			d="M26.212 13.5191C22.6755 9.98266 16.9404 9.98266 13.404 13.5191C9.86757 17.0555 9.86757 22.7906 13.404 26.3271C16.5368 29.4599 21.3955 29.8135 24.9204 27.3957L29.3294 32.3274C30.079 33.1692 31.382 33.2038 32.1777 32.4081L32.2931 32.2928C33.0888 31.4971 33.0542 30.194 32.2123 29.4445L27.2806 25.0355C29.7023 21.5068 29.3448 16.6519 26.212 13.5191ZM24.0132 24.1283C21.6915 26.4501 17.9244 26.4501 15.6027 24.1283C13.281 21.8066 13.281 18.0395 15.6027 15.7178C17.9244 13.3961 21.6915 13.3961 24.0132 15.7178C26.3388 18.0434 26.335 21.8066 24.0132 24.1283Z"
			fill="#FEFDFE"
		/>
	</svg>
);
